...
const ModalNewTask = ({ projectId, isOpen, onClose }: Props) => {
  ...
  const inputStyles =
    "w-full rounded border border-gray-300 p-2 shadow-sm dark:border-dark-tertiary dark:bg-dark-tertiary dark:text-white dark:focues:outline-none";
