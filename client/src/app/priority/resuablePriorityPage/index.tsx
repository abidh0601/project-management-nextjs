...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    width: 130,
    renderCell: (params) => (
      <span className="font inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">
        {params.value}
      </span>
    ),
  },
  ...
  return (
    <div className="m-5 p-4">
      ...
      <Header
        ...
        buttonComponent={
          <button
            className="mr-3 rounded bg-blue-600 px-4 py-2 font-bold text-white hover:bg-blue-700"
